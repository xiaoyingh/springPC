...
//                              var vMp4url = "C:\Users\Administrator\Desktop\demo\TWST.mp4";
				...
				<!--点赞收藏分享-->
					<div class="myfx">
						...
						<div class="shopp-buy" style="width:106px;">
								<p class="buynow"><a href="<%=path %>/orderdeta?seriesID=${seriesID}" style="color:white;">购买完整课程</a></p >
							</div>
						</c:if>
					</div>
				</div>
						...
						<ul id="playid">	
							<c:forEach items="${lsvideo }" var="vo" varStatus="flag">		
								<li data-id="${playing }" value="${vo.ID }" name="playlist">
									<a href="play?seriesID=${vo.SID }&id=${vo.ID }" title="${vo.title}">${vo.title}</a>
		...
		<div class="play-kcjs clearfix">
			...
			<div class="play-right">
				<div class="right-top">
					...
					<div class="right-con">
						<ul>
							<c:forEach items="${rela}" var="rl" begin="0" end="5">
								<li>
									<div class="xgkc"><a href="firstplay?seriesID=${rl.ID}">
									<img class="lazy" alt="" width="128" height="80"
															src="cover/${rl.picURL }"/>
									</a></div>
									<div class="xgkc-list">
										<h6>${rl.title }</h6>
