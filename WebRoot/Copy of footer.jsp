				...
				<div class="con footer-con">
					<div class="section">
						<div class="footer_left">
							<a href="javascript:;">关于我们</a> <a href="javascript:;">媒体报道</a> <a
								href="javascript:;">商务合作</a> <a href="javascript:;">加入我们</a> <a
								href="javascript:;">常见问题</a> <a href="javascript:;">意见反馈</a>
						</div>
						<div class="footer_right">
							<a href="javascript:;">sub</a> <a href="javascript:;">sub</a>
...
<div class="login">
	...
	<div class="login-con logreg-active">
		<form action="" >
			...
			<div class="pass">
				<input type="password" placeholder="8-16位密码，区分大小写，不能用空格" class="password" id="login-pass" name="password" />
				<p id="passid"></p>
			</div>
		...
		<div class="qt-login">
			<h6>其他方式登录：
				...
				<span>
					<a href="http://www.shoutike.com/STK/loginqq" connect="qzone" config=" 'cp': 1000208, 'cpp': 4001521, 'width': 710, 'height': 400, 'title': '腾讯QQ' " title="用QQ账号登录" charset="hz-4003757-1000494"><img src="${pageContext.request.contextPath}/img/qq.png" /></a>
				</span>
				<span>
	...
	<div class="login-con">
		<form action="" method="post" id="reg-form">
			...
			<div class="pass">
				<input type="password" placeholder="设置8-16位密码，区分大小写，不能用空格" class="password" id="zc-pass"  />
				<p></p>
			</div>
			<div class="stk-tk">
...
<div class="register-next">
	...
	<div class="reg-con">
		<form action="update.action" method="post">
			...
			<div class="fpyhm">
				<input type="text" name="preferential" id="preferential"  placeholder="免费学习验证码(输入验证码免费学习课程)" />
				<p style="color: red;"></p >
			</div>
			<div class="tjzl">
...
<div class="forgetpass">
	...
	<div class="forget-con">
		<form action="" method="post" id="forget-form">
			<div class="call">
				<input type="text" placeholder="请输入注册手机号" class="username" id="forget-call" onblur="selectphonefor();" />
				<p></p >
			</div>
			<div class="xym">
			...
			<div class="yzm">
				<input type="text" placeholder="请输入短信验证码" disabled="disabled" id="forget-CheckCode" />
				<a href="javascript:;" class="yzm-btn" id="forget-getKey">获取验证码</a>
				<span id="forget-randomSpan"></span>
			</div>
			<div class="pass">
				<input type="password" placeholder="设置6-16位密码，区分大小写，不能用空格" class="password" id="forget-pass" />
				<p></p >
			</div>
