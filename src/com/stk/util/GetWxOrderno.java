...
import com.stk.util.http.HttpClientConnectionManager;
...
public class GetWxOrderno
{
  ...
  public static  Map tixian(String url,String xmlParam){
	  Map map = null;
  ...
  //pc
  public static String getPc(String url,String xmlParam){
	  System.out.println("xml是:"+xmlParam);
	  DefaultHttpClient client = new DefaultHttpClient();
	  client.getParams().setParameter(ClientPNames.ALLOW_CIRCULAR_REDIRECTS, true);
	  HttpPost httpost= HttpClientConnectionManager.getPostMethod(url);
...
//         Map<String, String> resultMap = (Map<String, String>)XMLUtil.doXMLParse(jsonStr);  
//       
